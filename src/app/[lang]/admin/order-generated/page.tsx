...
import { DataTable } from "@/components/admin/order-generated/table/data-table"
"@/components/admin/admin-footer"
import { Separator } from "@/components/ui/separator"
import AdminFooter from "@/components/admin/admin-footer"
import { ORDER_GENERATED } from "@/mock/order_generated"
...
export default async function OrderGeneratedPage({
  params: { lang }
}: {
  params: { lang: Locale }
}) {
    ...
    <div className="flex flex-col max-w-full space-y-8 grow">
      <div className={cn("h-16 flex flex-col items-start justify-between space-y-2 lg:flex-row md:space-y-0", {
        ...
        <h2 className={cn("w-full text-3xl font-bold tracking-tight", {
          ...
          {dict.admin.orderGenerated.title}
        </h2>
        <Button
          size="sm"
      ...
      <div className="w-full">
        <DataTable dict={dict} lang={lang} data={ORDER_GENERATED} />
      </div>
