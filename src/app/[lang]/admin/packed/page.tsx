...
import { DataTable } from "@/components/admin/packed/table/data-table"
import { PACKED_ORDERES } from "@/mock/packed-orderes"

export const metadata: Metadata = {
  title: "PackedPage",
  description: "Packed Orderes Page",
}
  ...
  return (
    <div className="flex flex-col max-w-full space-y-8 grow">
      ...
      <div className="w-full">
        <DataTable dict={dict} lang={lang} data={PACKED_ORDERES} />
      </div>
