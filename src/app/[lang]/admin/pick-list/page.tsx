...
import { DataTable } from "@/components/admin/pick-list/table/data-table"
"@/components/admin/admin-footer"
import { Separator } from "@/components/ui/separator"
import { PICK_LIST } from "@/mock/pick_list"
import AdminFooter from "@/components/admin/admin-footer"


export const metadata: Metadata = {
  title: "Pick List Page",
  description: "Pick List Page",
}
  ...
  return (
    <div className="flex flex-col max-w-full space-y-8 grow">
      ...
      <div className="w-full">
        <DataTable dict={dict} lang={lang} data={PICK_LIST} />
      </div>
